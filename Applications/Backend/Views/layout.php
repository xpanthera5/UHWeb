...
<head>
    ...
    <link href="<?= WEBSITE_URL ?>css/uhtec.css" rel="stylesheet">
...
<body class="<?= $bodyClass ?>">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand font-primary" href="index.html">UHTEC ADMINISTRATION</a>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a class="font-secondary" href="<?= WEBSITE_URL ?>admin/<?= $user_admin_id ?>/formation/ajouter">Ajouter une formation</a>
                            </li>
                            <li>
    ...
    <script src="<?= WEBSITE_URL ?>js/pages/index.js"></script>
