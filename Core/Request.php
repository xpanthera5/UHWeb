<?php
	...
	class Request
	{
		 ...
		 * @return {bool}
		 */
		public function paramsExists($key)
		{
			return isset($_GET[$key]);
		}
		 ...
		 * @return {bool}
		 */
		public function bodyExists($key)
		{
			return isset($_POST[$key]);
		}
		...
		/**
		 * Cree une nouvelle valeur pour une session
		 * @param $key : La cléf de la session
		...
		/**
		 * Renvoi la valeur d'une session
		 * @param $key : La clef de la session
		 */
